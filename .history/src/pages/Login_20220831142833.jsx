  ...
  return (
    <div className=' bg-[#f0f2f5] min-h-screen flex flex-row justify-center items-center gap-4'>
      ...
      <div className='flex flex-col gap-2'>
        <div className='bg-white w-[400px] drop-shadow-xl rounded-xl px-3 flex justify-center items-center flex-col'>
          ...
          <button className=' bg-green-600 px-6 py-3 rounded-[5px]'>
            Create Account
          </button>
        </div>
      </div>
